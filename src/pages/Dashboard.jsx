...
export default function Dashboard() {
  ...
  const aggregatedTpsData = useMemo(() => {
    ...
    return dashboardData.tpsHistory;
  }, [dashboardData?.tpsHistory]);
  ...
  if (!dashboardData) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#1d2d3a] text-white">
        Connecting…
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#1d2d3a] text-white">
      ...
      {error && (
        <div className="bg-red-500/10 px-4 py-2 flex items-center gap-2 text-red-400">
